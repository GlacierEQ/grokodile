...
class HandoffPackage:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.tests_passed, bool) or not isinstance(self.sha256_verified, bool):
    ...
    def compile(self) -> dict:
        ...
        return {
            ...
            "handoff_status": "CALLER_ASSERTS_READY" if ready else "EVIDENCE_INCOMPLETE",
